...
extension MapStore{
    ...
    func saveDiscoverableLandmarks() throws{
        let landmarks = [
            ...
            DiscoverableLandmark(name: "Plague column", hint: "Very tall column reminding people to keep their hygiene in check", titleImageUrl: "http://www.pruvodcebrnem.cz/fotografie/historicke-stavby/morovy-sloup/morovy-sloup-1.jpg", landmarkDescription: "Plague Column (also Marian Column) is a Baroque column on Freedom Square in Brno. It was built in 1679–1683 to commemorate the plague epidemic (hence the plague column) that plagued the city in 1679–1680. It is located in the northern (upper) part of the square and forms its dominant feature. It is dedicated to the Virgin Mary (hence the Marian column) and the five plague saints. Its early Baroque form is based on the form of the Marian column erected on the Am Hof square in Vienna.", landmarkReward: .plagueColumn, longitude: 16.607818, latitude: 49.195290),
